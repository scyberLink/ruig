...
import { ACTIVE_ELEMENT, DRAWING_CANVAS } from '../../../../../../common/constants';
...
class DrawingToolBar extends BaseComponent {
    constructor(style) {
        ...
        this.pickTool = new DrawingToolbarItem({});
        this.linkTool = new DrawingToolbarItem({});
        this.spanTool = new DrawingToolbarItem({});
        this.buttonTool = new DrawingToolbarItem({});
        this.inputTool = new DrawingToolbarItem({});
        this.pickTool.init({
        ...
        this.linkTool.action = () => {
            const canvas = SharedConfig.get(DRAWING_CANVAS);
        ...
        this.appendChildren(this.pickTool, this.linkTool, this.spanTool, this.buttonTool, this.inputTool);
    }
}
